...
function Faqs() {
  return (
    <div className='faqOuterMax'>
      <div className='content faqOuter'>
        <h1 className='text-center my-5'>Frequently Asked Questions</h1>
        <details>
          <summary>When is Jagriti 22' going to be held?</summary>
          <div className='faq__content'>
            <p>
              Jagriti 22’ is scheduled to be held from 15th April-17th April
              2022.
            </p>
          </div>
        </details>
        ...
        <details>
          ...
          <div className='faq__content'>
            <p>
              Please follow our instagram, facebook and linkedin handles under
              the name Jagriti for all updates.
            </p>
          </div>
        </details>
      </div>
